...
/// Layar login dipakai oleh ADMIN maupun CUSTOMER.
/// Kirim [isAdmin: true] untuk login admin, false untuk customer.
class LoginView extends StatefulWidget {
  final bool isAdmin;
  const LoginView({super.key, required this.isAdmin});
...
class _LoginViewState extends State<LoginView>
  ...
  Future<void> _doLogin() async {
    ...
    if (result.status) {
      AlertMessage.show(context, result.message, true);
      // Navigasi sesuai role dari respons
      ...
      AlertMessage.show(context, result.message, false);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final teal = Color.fromARGB(255, 33, 172, 145);
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(14),
              borderSide:
                  const BorderSide(color: Color.fromARGB(255, 33, 172, 145), width: 1.5),
            ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
              colors: [Color.fromARGB(255, 33, 172, 145), Color.fromARGB(255, 26, 155, 133)]),
